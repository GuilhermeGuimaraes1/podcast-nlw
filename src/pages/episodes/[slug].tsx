...
//toda rota que esta utilizado geração estatica e que tem parametros dinamicos
...
//vai criar a criar a pagina
export const getStaticProps: GetStaticProps = async (ctx) => { // de forma estatica
